...
# Gunakan st.cache_data untuk fungsi yang mengembalikan data murni.
@st.cache_data
def load_data():
...
# Gunakan st.cache_resource untuk fungsi yang mengembalikan resource berat, seperti model machine learning.
@st.cache_resource
...
if page == "Home":
    ...
    **Hi, I'm Salsa!**  
    ...
    I'm a first year student at President University and passionate about data science and interactive web applications. This project shows how machine learning can be applied to diabetes prediction.
